...
if ($success === true)
{
	...
	if($applicatF->updatePayStatus($email, $razorpayOrderId, $razorpayPaymentId, $paymentStatus, $updatestamp,$fee_type,$toValue ))
		{			
...
$updatestamp=date('Y-m-d h:i:s');
$applicatF->updatePayStatus($email, $razorpayOrderId, $razorpayPaymentId, $paymentStatus, $updatestamp ,$fee_type);
}
...
<div class="container-contact100">
  <div class="wrap-contact100">
	   <?php
	if(isset($errMSG)){
	    if(isset($_SESSION['payment_type']) && isset($_SESSION['total_price'])){
			unset($_SESSION['payment_type']);
			unset($_SESSION['total_price']);
			
			echo "<script language='javascript'>window.location.href = '../../AddOnCourses/enrolled.php'</script>";
		} 
		  echo "<script language='javascript'>window.location.href = '../sfee.php'</script>";
	}
