...
$Guardian_Occupation=$_POST['goccupation'];
$Father_Number=$_POST['fmobile'];
$Mother_Number=$_POST['mmobile'];
$Guardian_Number=$_POST['gmobile'];
$Father_email=$_POST['femail'];
$Mother_email=$_POST['memail'];
$Guardian_email=$_POST['gemail'];
$Father_AI=$_POST['fincome'];
$Mother_AI=$_POST['mincome'];
$Guardian_AI=$_POST['gincome'];
                    ...
                    ?>
                            ...
                            <tr>
                                <form method="post">
                                    ...
                                    <input type="hidden" name="femail" value="<?php echo $row['femail']; ?>">
                                    <input type="hidden" name="fmobile" value="<?php echo $row['fmobile']; ?>">
                                    <input type="hidden" name="foccupation" value="<?php echo $row['foccupation']; ?>">
                                    <input type="hidden" name="fincome" value="<?php echo $row['fincome']; ?>">

                                    <input type="hidden" name="mname" value="<?php echo $row['mname']; ?>">
                                    <input type="hidden" name="memail" value="<?php echo $row['memail']; ?>">
                                    <input type="hidden" name="mmobile" value="<?php echo $row['mmobile']; ?>">
                                    <input type="hidden" name="moccupation" value="<?php echo $row['moccupation']; ?>">
                                    <input type="hidden" name="mincome" value="<?php echo $row['mincome']; ?>">

                                    <input type="hidden" name="gname" value="<?php echo $row['gname']; ?>">
                                    <input type="hidden" name="gemail" value="<?php echo $row['gemail']; ?>">
                                    <input type="hidden" name="gmobile" value="<?php echo $row['gmobile']; ?>">
                                    <input type="hidden" name="goccupation" value="<?php echo $row['goccupation']; ?>">
                                    <input type="hidden" name="gincome" value="<?php echo $row['gincome']; ?>">
